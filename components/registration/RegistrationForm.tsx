    ...
    <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-4 sm:px-6 py-3 sm:py-4">
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="min-w-0">
            <h2 className="text-lg sm:text-xl font-bold text-white">Register New Document</h2>
            <p className="text-blue-100 text-xs sm:text-sm truncate">Fill in the details below to register</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-4 sm:p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-3 sm:mb-4">
          {/* Department */}
          <div>
            <label className="flex items-center gap-2 text-sm font-semibold text-gray-700 mb-1.5 sm:mb-2">
            ...
            <div className="relative">
              <select
                ...
                className="w-full px-3 sm:px-4 py-2.5 sm:py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 hover:border-blue-300 appearance-none bg-white cursor-pointer text-sm sm:text-base"
              >
          ...
          <div>
            ...
            <div className="relative">
              <select
                ...
                disabled={!department}
                className="w-full px-3 sm:px-4 py-2.5 sm:py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 hover:border-blue-300 disabled:bg-gray-50 disabled:cursor-not-allowed disabled:hover:border-gray-200 appearance-none bg-white cursor-pointer text-sm sm:text-base"
              >
                <option value="">{department ? "Select staff" : "Select dept first"}</option>
        ...
        <div className="mb-3 sm:mb-4">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <div className={`flex-1 px-3 sm:px-4 py-2.5 sm:py-3 rounded-xl font-mono text-xs sm:text-sm ${
              staffId
                ? "bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200 text-blue-700"
                : "bg-gray-50 border-2 border-gray-200 text-gray-400"
            }`}>
              {staffId || "Auto-populated"}
            </div>
            {staffId && (
              <div className="flex items-center gap-1 px-2 sm:px-3 py-1 bg-green-100 text-green-700 rounded-full text-xs font-medium flex-shrink-0">
        ...
        <div className="mb-3 sm:mb-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0 mb-1.5 sm:mb-2">
            ...
            <label className="flex items-center gap-2 text-sm text-gray-600 cursor-pointer group">
              ...
              <span className="group-hover:text-blue-600 transition-colors text-xs sm:text-sm">Custom number</span>
            </label>
          </div>
          <div className="relative">
            <input
              type="text"
              placeholder={useSpecificNumber ? "Enter number" : "Auto-generated"}
              value={mailingNumber}
              onChange={(e) => setMailingNumber(e.target.value)}
              readOnly={!useSpecificNumber}
              className={`w-full px-3 sm:px-4 py-2.5 sm:py-3 border-2 rounded-xl font-mono text-base sm:text-lg transition-all duration-200 ${
                useSpecificNumber
          ...
          {!useSpecificNumber && (
            <p className="text-[10px] sm:text-xs text-gray-500 mt-1.5 sm:mt-2 flex items-center gap-1">
              ...
              <span className="hidden sm:inline">Number is auto-generated (shared sequence for all document types)</span>
              <span className="sm:hidden">Auto-generated shared sequence</span>
            </p>
          )}
        </div>
        ...
        <div className="mb-4 sm:mb-6">
          ...
          <input
            ...
            className="w-full px-3 sm:px-4 py-2.5 sm:py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 hover:border-blue-300 text-sm sm:text-base"
          />
        </div>
        ...
        <button
          ...
          className={`
            w-full py-3 sm:py-4 rounded-xl font-semibold text-base sm:text-lg transition-all duration-200 flex items-center justify-center gap-2
        ...
        <div className="mt-3 sm:mt-4 flex items-center justify-center gap-1.5 sm:gap-2">
          <div className={`w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full transition-colors ${docType ? "bg-blue-500" : "bg-gray-300"}`}></div>
          <div className={`w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full transition-colors ${department ? "bg-blue-500" : "bg-gray-300"}`}></div>
          <div className={`w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full transition-colors ${name ? "bg-blue-500" : "bg-gray-300"}`}></div>
          <div className={`w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full transition-colors ${fileSecurityCode ? "bg-blue-500" : "bg-gray-300"}`}></div>
          <div className={`w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full transition-colors ${mailingNumber ? "bg-blue-500" : "bg-gray-300"}`}></div>
          <div className={`w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full transition-colors ${title ? "bg-blue-500" : "bg-gray-300"}`}></div>
        </div>
