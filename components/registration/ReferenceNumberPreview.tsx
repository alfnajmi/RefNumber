...
export default function ReferenceNumberPreview({
  ...
  return (
    <div className={`mb-6 rounded-xl overflow-hidden border-2 ${colors.border}`}>
      {/* Header */}
      <div className={`${colors.bg} px-4 py-2`}>
        <div className="flex items-center gap-2">
          ...
          <span className="text-white text-sm font-semibold">Generated Reference Number</span>
        </div>
      </div>
      ...
      <div className="bg-white p-4">
        <div className="flex items-center justify-center mb-4">
          <div className="px-6 py-3 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg border border-gray-200">
            <span className="text-xl font-mono font-bold text-gray-800 tracking-wide">
              {referenceNumber}
            </span>
          </div>
        </div>
